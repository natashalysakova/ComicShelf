...
namespace ComicShelf.Migrations
{
    ...
    [Migration("20230717160722_InitialCreate10")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ComicShelf.Model.Issue", b =>
                {
                    b.HasOne("ComicShelf.Model.Volume", "Volume")
                        .WithMany("Issues")
            ...
            modelBuilder.Entity("ComicShelf.Model.Publisher", b =>
                {
                    b.HasOne("ComicShelf.Model.Country", "Country")
                        .WithMany("Publishers")
            ...
            modelBuilder.Entity("ComicShelf.Model.Volume", b =>
                {
                    b.HasOne("ComicShelf.Model.Series", "Series")
                        .WithMany("Volumes")
